...
HEALTH_KEYWORDS = (
    ...
    # 독성 음식·섭취 사고·응급 (기능테스트에서 '초콜릿' 질의 미감지 발견 → 보강)
    "초콜릿", "초콜렛", "포도", "건포도", "양파", "마늘", "자일리톨", "마카다미아",
    "카페인", "커피", "알코올", "아보카도", "중독", "독성", "독이",
    "삼켰", "삼킴", "이물질", "약을 먹", "사람 약", "응급", "급해",
)
HEALTH_DISCLAIMER = (
...
OOS_RESPONSE = (
    ...
    "일반적인 안내를 드리면, 반려동물이 평소와 다르게 식욕 저하·무기력·구토 등의 "
    "모습을 보이면 해당 동물을 진료하는 동물병원에 상담하시는 것이 가장 안전합니다.\n"
